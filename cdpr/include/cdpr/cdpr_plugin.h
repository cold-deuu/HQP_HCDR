...
private:
    ...
    void ManipulatorCallBack(const sensor_msgs::JointStateConstPtr &_msg){
        
        m_joint_command_ =*_msg;
    }
...
private:
    ...
    ros::CallbackQueue m_callback_queue_;
    ...
    std::vector<physics::JointPtr> m_joints_;
    ...
    ros::Subscriber m_command_subscriber_;

    sensor_msgs::JointState m_joint_command_;
    ...
    ros::Publisher m_joint_state_publisher_;

    sensor_msgs::JointState m_joint_states_;
