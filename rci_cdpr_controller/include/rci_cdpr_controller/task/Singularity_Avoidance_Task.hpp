    ...
    namespace SE3_task{
        class Singularity_Avoidance_Task{
            public:            
                ...
                void Set_Current_State(Eigen::MatrixXd Jacob_tilda, Eigen::MatrixXd mass_tilda, Eigen::MatrixXd U_matrix, pinocchio::SE3 & current_pose, Eigen::VectorXd & current_twist);
            ...
            private:
                ...
                // Current State
                Eigen::MatrixXd m_Jacob_tilda, m_Mass_tilda, m_U_matrix;
