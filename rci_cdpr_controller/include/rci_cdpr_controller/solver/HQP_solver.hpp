...
namespace cdpr_controller{
    namespace HQP_solver{
        class cdpr_hqp{
            public:
                cdpr_hqp(int variables, int slacks);
                ...
                void Add_Task(Eigen::MatrixXd &A_Eq, Eigen::VectorXd &B_Eq, int Task_Level);
                void Add_Min_Task(Eigen::MatrixXd &Q, Eigen::VectorXd &C, int Task_Level);
                
                // Test
                void get_tilda(Eigen::MatrixXd & mass_tilda, Eigen::VectorXd & g_tilda);
                ...
                void Remove_Task();
                void Update_Task(Eigen::MatrixXd &A_Eq, Eigen::VectorXd &B_Eq, int Task_Level);
